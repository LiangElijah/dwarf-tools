        ...
        if(str[index] == '\0') {   // 字符串以 '\0' 结尾
            ...
            if(str[index] == '[') {    // 数组起始符
                if(count == 0) {        // 变量以 [ 开头
                    ...
                    return StrStatus_START_SQBRACKET;
                }
